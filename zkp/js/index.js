...
function loadCircuit(type) {
  ...
  // Use path.resolve with __dirname and the relative path to circuitsRoot
  const circuitsRoot = path.resolve(__dirname, '../../test/libs/circuits');

  console.log('circuitsRoot', circuitsRoot);
